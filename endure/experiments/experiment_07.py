"""
Experiment 07
Writes and Reads with default tuning on PyRocksDB
...
from lsm_tree.default import DefaultWorkloadTuning
...
class Experiment07(object):
    ...
    def create_tunings(self, wl_idxs, wl_rhos, expected_wls,
        ...
        for wl_idx, rho in zip(wl_idxs, wl_rhos):
            ...
            default = DefaultWorkloadTuning(cf)
            default_design = default.get_default_design()
            design['default_m_filt'] = default_design['M_filt']
            design['default_m_buff'] = default_design['M_buff']
            design['default_T'] = default_design['T']
            design['default_filter_policy'] = default_design['filter_policy']
